...
describe('<Grid />', () => {
  it('renders without crashing with empty grid and piece', () => {
    shallow(<Grid grid={[]} type="real" name="test" score={0} piece={[]} />)
  })

  it('renders without crashing with type "others"', () => {
  ...
  it('renders 4 tails for the grid and none for an empty piece', () => {
    const piece = new Array(4).fill(1)
